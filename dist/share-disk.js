...
import { Group as P, TextInput as Fe, ActionIcon as d1, Table as M, Checkbox as z1, Box as p1, Text as X1, Anchor as h1, Breadcrumbs as Ze, Menu as X, Button as W1, MantineProvider as De, Modal as Be } from "@mantine/core";
...
function $e() {
  return N1 || (N1 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var t1 = V.ReactCurrentDispatcher, r1;
    function q(e, t, n) {
      {
        if (r1 === void 0)
          try {
...
` + s[w].replace(" at new ", " at ");
    ...
    var z = Object.prototype.hasOwnProperty, k1 = {}, M1 = V.ReactDebugCurrentFrame;
    function K(e) {
      if (e) {
    ...
    function xe(e, t) {
      {
        var n = function() {
          P1 || (P1 = !0, T("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", t));
        };
    ...
    function Te(e, t) {
      {
        var n = function() {
          V1 || (V1 = !0, T("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", t));
        };
    ...
    var o1 = V.ReactCurrentOwner, O1 = V.ReactDebugCurrentFrame;
    function Z(e) {
      if (e) {
        var t = e._owner, n = G(e.type, e._source, t ? t.type : null);
    ...
    function B1(e, t, n, o, d, h) {
      {
        ...
        if (z.call(t, "key")) {
          var I = H(e), _ = Object.keys(t).filter(function(Ve) {
            return Ve !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, c1, I, Pe, I), D1[I + c1] = !0;
          }
        }
...
var Y1;
function Ne() {
  return Y1 || (Y1 = 1, process.env.NODE_ENV === "production" ? Q.exports = We() : Q.exports = $e()), Q.exports;
}
var a = Ne();
/**
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
var Ue = U("outline", "chevron-right", "IconChevronRight", [["path", { d: "M9 6l6 6l-6 6", key: "svg-0" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var qe = U("outline", "folder", "IconFolder", [["path", { d: "M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2", key: "svg-0" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var Je = U("outline", "info-circle", "IconInfoCircle", [["path", { d: "M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0", key: "svg-0" }], ["path", { d: "M12 9h.01", key: "svg-1" }], ["path", { d: "M11 12h1v4h1", key: "svg-2" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var Ge = U("outline", "search", "IconSearch", [["path", { d: "M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0", key: "svg-0" }], ["path", { d: "M21 21l-6 -6", key: "svg-1" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
  ...
  return /* @__PURE__ */ a.jsxs(P, { gap: 10, h: 64, px: "lg", styles: { root: { flexShrink: 0 } }, children: [
    ...
    /* @__PURE__ */ a.jsx(
      Fe,
      {
        ...
        placeholder: "Поиск",
        value: y,
        leftSection: /* @__PURE__ */ a.jsx(Ge, { stroke: 1.2 }),
...
const Qe = (r, f = 2) => {
  ...
  var p;
  const f = ((p = Object.values(e2).find((c) => c.mimeType === r)) == null ? void 0 : p.iconType) ?? "";
  if (!r) return /* @__PURE__ */ a.jsx(f2, { width: 20 });
  const y = d2[f];
  return y ? /* @__PURE__ */ a.jsx(y, { width: 20 }) : /* @__PURE__ */ a.jsx(u2, { width: 20 });
}, h2 = "_row_1xr8m_1", C2 = "_highlight_1xr8m_15", m2 = "_rowCheckbox_1xr8m_23", v2 = "_rowCheckboxVisible_1xr8m_31", f1 = {
  row: h2,
  highlight: C2,
  rowCheckbox: m2,
  rowCheckboxVisible: v2
};
function g2({
  rows: r,
  selectedRowIds: f,
  ...
  return /* @__PURE__ */ a.jsx(M.ScrollContainer, { minWidth: 760, h: "100%", children: /* @__PURE__ */ a.jsxs(M, { stickyHeader: !0, verticalSpacing: "xs", horizontalSpacing: "lg", children: [
    /* @__PURE__ */ a.jsx(M.Thead, { children: /* @__PURE__ */ a.jsxs(M.Tr, { children: [
      /* @__PURE__ */ a.jsx(M.Th, { c: "gray.6", fw: 500, fz: "xs", tt: "uppercase", children: /* @__PURE__ */ a.jsxs(P, { gap: "xs", children: [
        /* @__PURE__ */ a.jsx(
          z1,
          {
            size: "xs",
    ...
    /* @__PURE__ */ a.jsx(M.Tbody, { children: r.map((l) => /* @__PURE__ */ a.jsxs(
      M.Tr,
      {
        ...
        children: [
          /* @__PURE__ */ a.jsx(M.Td, { fz: "sm", children: /* @__PURE__ */ a.jsxs(P, { gap: "xs", children: [
            ...
            /* @__PURE__ */ a.jsxs(P, { gap: 10, children: [
              /* @__PURE__ */ a.jsx(
                p2,
                {
          ...
          /* @__PURE__ */ a.jsx(M.Td, { fz: "sm", c: "dimmed", children: "Size" in l ? isNaN(+l.Size) ? null : Qe(+l.Size) : "-" })
        ]
      },
      l.Id
    )) })
...
function y2({
  ...
  return /* @__PURE__ */ a.jsx(P, { h: 48, py: 8, px: "lg", styles: { root: { flexShrink: 0 } }, children: /* @__PURE__ */ a.jsx(
    Ze,
    {
      separatorMargin: 6,
      separator: /* @__PURE__ */ a.jsx(Ue, { stroke: 1.2, size: 17 }),
      children: p.map(
        (c, C) => c.children ? /* @__PURE__ */ a.jsxs(X, { children: [
          ...
          /* @__PURE__ */ a.jsx(X.Dropdown, { children: c.children.map((v) => /* @__PURE__ */ a.jsx(
            X.Item,
            {
              c: "dark",
              fz: "sm",
              leftSection: /* @__PURE__ */ a.jsx(qe, { stroke: 1.2, size: 18 }),
              children: v.title
            },
            v.id
          )) })
  ...
  return /* @__PURE__ */ a.jsxs(
    P,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a.jsxs(P, { gap: "xs", ml: "auto", children: [
...
function R2({
  ...
  }, [r, L]), /* @__PURE__ */ a.jsx(De, { children: /* @__PURE__ */ a.jsx(
    Be,
    {
      centered: !0,
      withCloseButton: !1,
      ...
      children: /* @__PURE__ */ a.jsxs(p1, { h: 500, pos: "relative", children: [
        /* @__PURE__ */ a.jsx(Xe, { onSearch: A, onClose: f }),
        /* @__PURE__ */ a.jsx(
          y2,
          {
            directory: v,
