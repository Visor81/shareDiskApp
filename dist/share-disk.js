...
import re, { forwardRef as Oe, createElement as C1, useState as $, useMemo as ne, useCallback as Ie, useEffect as Ae } from "react";
import { Group as I, TextInput as Fe, ActionIcon as v1, Table as L, Checkbox as q1, Box as g1, Text as ie, Anchor as y1, Breadcrumbs as Ze, Menu as n1, Button as J1, MantineProvider as De, Modal as Be, LoadingOverlay as ze } from "@mantine/core";
import $e, { isAxiosError as Ne } from "axios";
var i1 = { exports: {} }, J = {};
/**
 * @license React
...
function We() {
  if (G1) return J;
  G1 = 1;
  var r = re, d = Symbol.for("react.element"), w = Symbol.for("react.fragment"), h = Object.prototype.hasOwnProperty, c = r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, m = { key: !0, ref: !0, __self: !0, __source: !0 };
  function g(b, v, l) {
    var y, E = {}, k = null, H = null;
    l !== void 0 && (k = "" + l), v.key !== void 0 && (k = "" + v.key), v.ref !== void 0 && (H = v.ref);
    for (y in v) h.call(v, y) && !m.hasOwnProperty(y) && (E[y] = v[y]);
    if (b && b.defaultProps) for (y in v = b.defaultProps, v) E[y] === void 0 && (E[y] = v[y]);
    return { $$typeof: d, type: b, key: k, ref: H, props: E, _owner: c.current };
  }
  return J.Fragment = w, J.jsx = g, J.jsxs = g, J;
}
var G = {};
/**
 * @license React
...
function Ye() {
  return K1 || (K1 = 1, process.env.NODE_ENV !== "production" && function() {
    var r = re, d = Symbol.for("react.element"), w = Symbol.for("react.portal"), h = Symbol.for("react.fragment"), c = Symbol.for("react.strict_mode"), m = Symbol.for("react.profiler"), g = Symbol.for("react.provider"), b = Symbol.for("react.context"), v = Symbol.for("react.forward_ref"), l = Symbol.for("react.suspense"), y = Symbol.for("react.suspense_list"), E = Symbol.for("react.memo"), k = Symbol.for("react.lazy"), H = Symbol.for("react.offscreen"), V = Symbol.iterator, A = "@@iterator";
    function a1(e) {
    ...
    function P(e, t, n) {
      {
        var o = O.ReactDebugCurrentFrame, p = o.getStackAddendum();
        p !== "" && (t += "%s", n = n.concat([p]));
    ...
    var N = !1, M = !1, W = !1, D = !1, X = !1, b1;
    b1 = Symbol.for("react.module.reference");
    function oe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === h || e === m || X || e === c || e === l || e === y || D || e === H || N || M || W || typeof e == "object" && e !== null && (e.$$typeof === k || e.$$typeof === E || e.$$typeof === g || e.$$typeof === b || e.$$typeof === v || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
      e.$$typeof === b1 || e.getModuleId !== void 0));
    }
    function le(e, t, n) {
      var o = e.displayName;
      if (o)
    ...
    function S(e) {
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          ...
          case k: {
            var p = e, C = p._payload, u = p._init;
            try {
              return S(u(C));
            } catch {
              return null;
    ...
    var F = Object.assign, Y = 0, _1, j1, L1, k1, M1, S1, H1;
    function P1() {
    }
    ...
    function se() {
      {
        if (Y === 0) {
          _1 = console.log, j1 = console.info, L1 = console.warn, k1 = console.error, M1 = console.group, S1 = console.groupCollapsed, H1 = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: P1,
    ...
    var o1 = O.ReactCurrentDispatcher, l1;
    function Q(e, t, n) {
      {
        if (l1 === void 0)
          try {
...
` + l1 + e;
    ...
    function V1(e, t) {
      ...
      var C;
      C = o1.current, o1.current = null, se();
      try {
        if (t) {
          var u = function() {
            throw Error();
...
`), R = o.stack.split(`
`), x = s.length - 1, T = R.length - 1; x >= 1 && T >= 0 && s[x] !== R[T]; )
            T--;
          for (; x >= 1 && T >= 0; x--, T--)
            if (s[x] !== R[T]) {
              if (x !== 1 || T !== 1)
...
` + s[x].replace(" at new ", " at ");
                    return e.displayName && j.includes("<anonymous>") && (j = j.replace("<anonymous>", e.displayName)), typeof e == "function" && e1.set(e, j), j;
                  }
                while (x >= 1 && T >= 0);
              break;
            }
        ...
        s1 = !1, o1.current = C, ce(), Error.prepareStackTrace = p;
      }
      var z = e ? e.displayName || e.name : "", Z = z ? Q(z) : "";
      return typeof e == "function" && e1.set(e, Z), Z;
    }
    function fe(e, t, n) {
      return V1(e, !1);
    }
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          case v:
            return fe(e.render);
          case E:
            return t1(e.type, t, n);
          case k: {
            var o = e, p = o._payload, C = o._init;
            try {
              return t1(C(p), t, n);
            } catch {
            }
    ...
    var U = Object.prototype.hasOwnProperty, O1 = {}, I1 = O.ReactDebugCurrentFrame;
    function r1(e) {
      if (e) {
        var t = e._owner, n = t1(e.type, e._source, t ? t.type : null);
        I1.setExtraStackFrame(n);
      } else
        I1.setExtraStackFrame(null);
    }
    function pe(e, t, n, o, p) {
      {
        ...
        for (var u in e)
          if (C(e, u)) {
            ...
            s && !(s instanceof Error) && (r1(p), f("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", o || "React class", n, u, typeof s), r1(null)), s instanceof Error && !(s.message in O1) && (O1[s.message] = !0, r1(p), f("Failed %s type: %s", n, s.message), r1(null));
          }
      }
    }
    ...
    function F1(e) {
      if (me(e))
        return f("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Ce(e)), A1(e);
    }
    var q = O.ReactCurrentOwner, ve = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function we(e, t) {
      if (typeof e.ref == "string" && q.current && t && q.current.stateNode !== t) {
        var n = S(q.current.type);
        u1[n] || (f('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', S(q.current.type), e.ref), u1[n] = !0);
      }
    }
    function xe(e, t) {
      {
        var n = function() {
          Z1 || (Z1 = !0, f("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", t));
        };
    ...
    function Te(e, t) {
      {
        var n = function() {
          D1 || (D1 = !0, f("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", t));
        };
    ...
    function be(e, t, n, o, p) {
      {
        var C, u = {}, s = null, R = null;
        n !== void 0 && (F1(n), s = "" + n), ye(t) && (F1(t.key), s = "" + t.key), ge(t) && (R = t.ref, we(t, p));
        for (C in t)
          U.call(t, C) && !ve.hasOwnProperty(C) && (u[C] = t[C]);
        if (e && e.defaultProps) {
        ...
        return Ee(e, s, R, p, o, q.current, u);
      }
    }
    var f1 = O.ReactCurrentOwner, B1 = O.ReactDebugCurrentFrame;
    function B(e) {
      if (e) {
        var t = e._owner, n = t1(e.type, e._source, t ? t.type : null);
    ...
    function N1(e, t) {
      {
        ...
        $1[n] = !0;
        var o = "";
        e && e._owner && e._owner !== f1.current && (o = " It was passed a child from " + S(e._owner.type) + "."), B(e), f('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', n, o), B(null);
      }
    }
    function W1(e, t) {
      {
        ...
        if (c1(e))
          ...
          if (typeof p == "function" && p !== e.entries)
            for (var C = p.call(e), u; !(u = C.next()).done; )
              p1(u.value) && N1(u.value, t);
        }
      }
    }
    function je(e) {
    ...
    function Le(e) {
      {
        for (var t = Object.keys(e.props), n = 0; n < t.length; n++) {
          var o = t[n];
          if (o !== "children" && o !== "key") {
            B(e), f("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", o), B(null);
            break;
          }
        }
        e.ref !== null && (B(e), f("Invalid attribute `ref` supplied to `React.Fragment`."), B(null));
      }
    }
    var Y1 = {};
    function U1(e, t, n, o, p, C) {
      {
        var u = oe(e);
        if (!u) {
          var s = "";
          ...
          R ? s += R : s += z1();
          var x;
          e === null ? x = "null" : c1(e) ? x = "array" : e !== void 0 && e.$$typeof === d ? (x = "<" + (S(e.type) || "Unknown") + " />", s = " Did you accidentally export a JSX literal instead of a component?") : x = typeof e, f("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", x, s);
        }
        var T = be(e, t, n, p, C);
        if (T == null)
          return T;
        ...
        if (U.call(t, "key")) {
          var Z = S(e), _ = Object.keys(t).filter(function(Ve) {
            return Ve !== "key";
          }), h1 = _.length > 0 ? "{key: someKey, " + _.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!Y1[Z + h1]) {
            var Pe = _.length > 0 ? "{" + _.join(": ..., ") + ": ...}" : "{}";
            f(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, h1, Z, Pe, Z), Y1[Z + h1] = !0;
          }
        }
        return e === h ? Le(T) : je(T), T;
      }
    }
    function ke(e, t, n) {
      return U1(e, t, n, !0);
    ...
    var Se = Me, He = ke;
    G.Fragment = h, G.jsx = Se, G.jsxs = He;
  }()), G;
}
var X1;
function Ue() {
  return X1 || (X1 = 1, process.env.NODE_ENV === "production" ? i1.exports = We() : i1.exports = Ye()), i1.exports;
}
var a = Ue();
/**
...
const K = (r, d, w, h) => {
  const c = Oe(
    ({ color: m = "currentColor", size: g = 24, stroke: b = 2, title: v, className: l, children: y, ...E }, k) => C1(
      "svg",
      {
        ref: k,
        ...qe[r],
        width: g,
        height: g,
        className: ["tabler-icon", `tabler-icon-${d}`, l].join(" "),
        strokeWidth: b,
        stroke: m,
        ...E
      },
      [
        v && C1("title", { key: "svg-title" }, v),
        ...h.map(([H, V]) => C1(H, V)),
        ...Array.isArray(y) ? y : [y]
      ]
    )
  );
  return c.displayName = `${w}`, c;
};
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
var Je = K("outline", "chevron-right", "IconChevronRight", [["path", { d: "M9 6l6 6l-6 6", key: "svg-0" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var Ge = K("outline", "folder", "IconFolder", [["path", { d: "M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2", key: "svg-0" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var Ke = K("outline", "info-circle", "IconInfoCircle", [["path", { d: "M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0", key: "svg-0" }], ["path", { d: "M12 9h.01", key: "svg-1" }], ["path", { d: "M11 12h1v4h1", key: "svg-2" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var Xe = K("outline", "search", "IconSearch", [["path", { d: "M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0", key: "svg-0" }], ["path", { d: "M21 21l-6 -6", key: "svg-1" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
  ...
  return /* @__PURE__ */ a.jsxs(I, { gap: 10, h: 64, px: "lg", styles: { root: { flexShrink: 0 } }, children: [
    ...
    /* @__PURE__ */ a.jsx(
      Fe,
      {
        ...
        placeholder: "Поиск",
        value: w,
        leftSection: /* @__PURE__ */ a.jsx(Xe, { stroke: 1.2 }),
        rightSection: !!w && /* @__PURE__ */ a.jsx(
          v1,
          {
            variant: "transparent",
            color: "gray",
            ...
            children: /* @__PURE__ */ a.jsx(w1, { stroke: 1.2 })
          }
        ),
        onChange: (c) => h(c.currentTarget.value),
        onKeyDown: (c) => c.key === "Enter" && r(w.trim())
      }
    ),
    /* @__PURE__ */ a.jsx(
      v1,
      {
        ...
        size: "lg",
        onClick: d,
        children: /* @__PURE__ */ a.jsx(w1, { size: 25, stroke: 1.2 })
      }
    )
  ] });
}
const t2 = (r, d = 2) => {
  if (!+r) return "0 Б";
  const w = 1024, h = d < 0 ? 0 : d, c = ["Б", "КБ", "МБ", "ГБ", "ТБ", "ПБ", "ЭБ", "ЗБ", "ЙБ"], m = Math.floor(Math.log(r) / Math.log(w));
  return `${parseFloat((r / Math.pow(w, m)).toFixed(h))} ${c[m]}`;
}, r2 = {
  pdf: {
    fileType: "pdf",
    documentType: "word",
  ...
  var h;
  const d = ((h = Object.values(r2).find((c) => c.mimeType === r)) == null ? void 0 : h.iconType) ?? "";
  if (!r) return /* @__PURE__ */ a.jsx(p2, { width: 20 });
  const w = h2[d];
  return w ? /* @__PURE__ */ a.jsx(w, { width: 20 }) : /* @__PURE__ */ a.jsx(d2, { width: 20 });
}, m2 = "_row_1xr8m_1", v2 = "_highlight_1xr8m_15", g2 = "_rowCheckbox_1xr8m_23", y2 = "_rowCheckboxVisible_1xr8m_31", m1 = {
  row: m2,
  highlight: v2,
  rowCheckbox: g2,
  rowCheckboxVisible: y2
};
function w2({
  rows: r,
  selectedRowIds: d,
  ...
  const c = r.length === d.length, m = !c && !!d.length, g = (l) => d.includes(l), b = () => h(d.length ? [] : r.map((l) => l.Id)), v = (l) => h(
    d.includes(l) ? d.filter((y) => y !== l) : d.concat(l)
  );
  return /* @__PURE__ */ a.jsx(L.ScrollContainer, { minWidth: 760, h: "100%", children: /* @__PURE__ */ a.jsxs(L, { stickyHeader: !0, verticalSpacing: "xs", horizontalSpacing: "lg", children: [
    /* @__PURE__ */ a.jsx(L.Thead, { children: /* @__PURE__ */ a.jsxs(L.Tr, { children: [
      /* @__PURE__ */ a.jsx(L.Th, { c: "gray.6", fw: 500, fz: "xs", tt: "uppercase", children: /* @__PURE__ */ a.jsxs(I, { gap: "xs", children: [
        /* @__PURE__ */ a.jsx(
          q1,
          {
            size: "xs",
      ...
      /* @__PURE__ */ a.jsx(L.Th, { c: "gray.6", fw: 500, fz: "xs", tt: "uppercase", children: "Изменен" }),
      /* @__PURE__ */ a.jsx(L.Th, { c: "gray.6", fw: 500, fz: "xs", tt: "uppercase", children: "Размер" })
    ] }) }),
    /* @__PURE__ */ a.jsx(L.Tbody, { children: r.map((l) => /* @__PURE__ */ a.jsxs(
      L.Tr,
      {
        className: m1.row + (g(l.Id) ? ` ${m1.highlight}` : ""),
        onMouseDown: "MimeType" in l ? () => v(l.Id) : void 0,
        children: [
          /* @__PURE__ */ a.jsx(L.Td, { fz: "sm", children: /* @__PURE__ */ a.jsxs(I, { gap: "xs", children: [
            /* @__PURE__ */ a.jsx(g1, { h: 16, w: 16, children: "MimeType" in l && /* @__PURE__ */ a.jsx(
              q1,
              {
                readOnly: !0,
                size: "xs",
                checked: g(l.Id),
                className: m1.rowCheckbox
              }
            ) }),
            /* @__PURE__ */ a.jsxs(I, { gap: 10, children: [
              /* @__PURE__ */ a.jsx(
                C2,
                {
              ...
              "MimeType" in l ? /* @__PURE__ */ a.jsx(ie, { truncate: !0, c: "gray.8", title: l.Name, maw: 340, children: l.Name }) : /* @__PURE__ */ a.jsx(
                y1,
                {
                  truncate: !0,
                  c: "gray.8",
          ...
          /* @__PURE__ */ a.jsx(L.Td, { fz: "sm", c: "dimmed", children: /* @__PURE__ */ a.jsx("span", { title: new Date(l.Timestamp).toLocaleString("ru-Ru"), children: new Date(l.Timestamp).toLocaleString("ru-Ru") }) }),
          /* @__PURE__ */ a.jsx(L.Td, { fz: "sm", c: "dimmed", children: "Size" in l ? isNaN(+l.Size) ? null : t2(+l.Size) : "-" })
        ]
      },
      l.Id
    )) })
...
function x2({
  ...
  const h = ne(() => {
    ...
    if (m.length > Q1) {
      const g = m.splice(1, m.length - Q1);
      m.splice(1, 0, { id: 0, title: "...", children: g });
    }
    return m;
  }, [r, d]);
  return /* @__PURE__ */ a.jsx(I, { h: 48, py: 8, px: "lg", styles: { root: { flexShrink: 0 } }, children: /* @__PURE__ */ a.jsx(
    Ze,
    {
      separatorMargin: 6,
      separator: /* @__PURE__ */ a.jsx(Je, { stroke: 1.2, size: 17 }),
      children: h.map(
        (c, m) => c.children ? /* @__PURE__ */ a.jsxs(n1, { children: [
          /* @__PURE__ */ a.jsx(n1.Target, { children: /* @__PURE__ */ a.jsx(y1, { c: "dimmed", children: "..." }) }),
          /* @__PURE__ */ a.jsx(n1.Dropdown, { children: c.children.map((g) => /* @__PURE__ */ a.jsx(
            n1.Item,
            {
              c: "dark",
              fz: "sm",
              leftSection: /* @__PURE__ */ a.jsx(Ge, { stroke: 1.2, size: 18 }),
              children: g.title
            },
            g.id
          )) })
          ...
          y1,
          {
            ...
            c: m === h.length - 1 ? "dark" : "dimmed",
            fw: m === h.length - 1 ? 500 : 400,
            maw: 200,
            onClick: c.id === 0 ? void 0 : () => w(c.id),
            children: c.title
          },
          m
        )
...
var ae = /* @__PURE__ */ ((r) => (r[r.Docs = 16] = "Docs", r))(ae || {}), x1 = /* @__PURE__ */ ((r) => (r[r.Id = 0] = "Id", r[r.Name = 1] = "Name", r[r.Type = 2] = "Type", r[r.Size = 3] = "Size", r[r.Author = 4] = "Author", r[r.Date = 5] = "Date", r[r.UpdateDate = 6] = "UpdateDate", r))(x1 || {}), T1 = /* @__PURE__ */ ((r) => (r[r.Asc = 0] = "Asc", r[r.Desc = 1] = "Desc", r))(T1 || {});
const E1 = $e.create({
  baseURL: "/api"
}), ee = (r) => E1.get("v1/DocumentDirectory/Get", { params: r }), T2 = (r) => E1.get("v1/DocumentDirectory/Search", {
  params: { ...r, field: "All" }
});
function E2({
  count: r,
  ...
  return /* @__PURE__ */ a.jsxs(
    I,
    {
      ...
      w: "100%",
      children: [
        /* @__PURE__ */ a.jsx(v1, { onClick: d, children: /* @__PURE__ */ a.jsx(w1, {}) }),
        /* @__PURE__ */ a.jsxs(ie, { children: [
          "Выбрано: ",
          r
        ] }),
        /* @__PURE__ */ a.jsxs(I, { gap: "xs", ml: "auto", children: [
          /* @__PURE__ */ a.jsx(J1, { variant: "outline", color: "#fff", onClick: w, children: "Прикрепить файл" }),
          /* @__PURE__ */ a.jsx(J1, { variant: "default", onClick: h, children: "Добавить ссылку" })
        ] }),
        /* @__PURE__ */ a.jsx(Ke, {})
      ]
    }
...
function j2({
  ...
  const [c, m] = $(te), [g, b] = $(null), [v, l] = $(null), [y, E] = $([]), [k, H] = $(!1), V = ne(() => v ? [...v.Directory.Items, ...v.Document.Items] : [...(g == null ? void 0 : g.Children) ?? [], ...(g == null ? void 0 : g.Documents) ?? []], [g, v]), A = Ie(
    async (f) => {
      const { data: P } = await ee(f);
      b(P[0]), l(null);
    },
    []
  ), a1 = async (f) => {
    ...
    try {
      const W = (await Promise.all(
        f.map(
          (D) => E1.get(`/v1/Documents/Download?id=${D.Id}&download=false`)
        )
      )).map(
        (D, X) => new File([D.data], f[X].Name, {
  ...
  return Ae(() => {
    if (r)
      return (async () => {
        ...
        m(te), b(null), l(null), E([]);
      };
  }, [r, A]), /* @__PURE__ */ a.jsx(De, { children: /* @__PURE__ */ a.jsx(
    Be,
    {
      centered: !0,
      withCloseButton: !1,
      ...
      children: /* @__PURE__ */ a.jsxs(g1, { h: 500, pos: "relative", children: [
        /* @__PURE__ */ a.jsx(ze, { visible: k }),
        /* @__PURE__ */ a.jsx(e2, { onSearch: a1, onClose: d }),
        /* @__PURE__ */ a.jsx(
          x2,
          {
            directory: g,
            isSearch: !!v,
            onItemClick: (f) => A({ ...c, id: f })
          }
        ),
        /* @__PURE__ */ a.jsx(g1, { h: "calc(100% - 64px - 48px)", children: /* @__PURE__ */ a.jsx(
          w2,
          {
            rows: V,
            selectedRowIds: y,
            onOpenDir: (f) => A({ ...c, id: f }),
            onSelect: (f) => E(f)
          }
        ) }),
        !!y.length && /* @__PURE__ */ a.jsx(
          E2,
          {
            count: V.length,
            onClose: () => E([]),
