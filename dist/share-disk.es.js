...
import de, { forwardRef as ze, createElement as F1, useState as W, useMemo as v1, useCallback as $e, useEffect as Ne } from "react";
import { Group as A, TextInput as We, ActionIcon as g1, Button as H1, Table as Z, Checkbox as re, Box as V1, Text as Z1, Anchor as P1, Breadcrumbs as Ue, Menu as h1, Flex as Ye, MantineProvider as Ge, Modal as Je, LoadingOverlay as qe } from "@mantine/core";
import Ke, { isAxiosError as Xe } from "axios";
import { useMediaQuery as y1 } from "@mantine/hooks";
var m1 = { exports: {} }, i1 = {};
/**
 * @license React
...
function Qe() {
  if (ne) return i1;
  ne = 1;
  var t = de, c = Symbol.for("react.element"), m = Symbol.for("react.fragment"), d = Object.prototype.hasOwnProperty, g = t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, x = { key: !0, ref: !0, __self: !0, __source: !0 };
  function u(s, p, w) {
    var l, E = {}, k = null, O = null;
    w !== void 0 && (k = "" + w), p.key !== void 0 && (k = "" + p.key), p.ref !== void 0 && (O = p.ref);
    for (l in p) d.call(p, l) && !x.hasOwnProperty(l) && (E[l] = p[l]);
    if (s && s.defaultProps) for (l in p = s.defaultProps, p) E[l] === void 0 && (E[l] = p[l]);
    return { $$typeof: c, type: s, key: k, ref: O, props: E, _owner: g.current };
  }
  return i1.Fragment = m, i1.jsx = u, i1.jsxs = u, i1;
}
var l1 = {};
/**
 * @license React
...
function e2() {
  return ae || (ae = 1, process.env.NODE_ENV !== "production" && function() {
    var t = de, c = Symbol.for("react.element"), m = Symbol.for("react.portal"), d = Symbol.for("react.fragment"), g = Symbol.for("react.strict_mode"), x = Symbol.for("react.profiler"), u = Symbol.for("react.provider"), s = Symbol.for("react.context"), p = Symbol.for("react.forward_ref"), w = Symbol.for("react.suspense"), l = Symbol.for("react.suspense_list"), E = Symbol.for("react.memo"), k = Symbol.for("react.lazy"), O = Symbol.for("react.offscreen"), J = Symbol.iterator, s1 = "@@iterator";
    function $(e) {
    ...
    function q(e, n, a) {
      {
        var o = B.ReactDebugCurrentFrame, v = o.getStackAddendum();
        v !== "" && (n += "%s", a = a.concat([v]));
        var y = a.map(function(C) {
          return String(C);
        });
        y.unshift("Warning: " + n), Function.prototype.apply.call(console[e], console, y);
      }
    }
    var x1 = !1, I = !1, E1 = !1, D = !1, U = !1, t1;
    t1 = Symbol.for("react.module.reference");
    function c1(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === d || e === x || U || e === g || e === w || e === l || D || e === O || x1 || I || E1 || typeof e == "object" && e !== null && (e.$$typeof === k || e.$$typeof === E || e.$$typeof === u || e.$$typeof === s || e.$$typeof === p || // This needs to include all possible module reference object
    ...
    function H(e) {
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          case s:
            var n = e;
            return d1(n) + ".Consumer";
          case u:
            var a = e;
            return d1(a._context) + ".Provider";
          case p:
          ...
          case k: {
            var v = e, y = v._payload, C = v._init;
            try {
              return H(C(y));
            } catch {
              return null;
    ...
    var z = Object.assign, h = 0, L, j, b, K, Y, r1, D1;
    function A1() {
    }
    ...
    function he() {
      {
        if (h === 0) {
          L = console.log, j = console.info, b = console.warn, K = console.error, Y = console.group, r1 = console.groupCollapsed, D1 = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: A1,
    ...
    var b1 = B.ReactCurrentDispatcher, M1;
    function u1(e, n, a) {
      {
        if (M1 === void 0)
          try {
...
` + M1 + e;
    ...
    function z1(e, n) {
      ...
      var y;
      y = b1.current, b1.current = null, he();
      try {
        if (n) {
          var C = function() {
            throw Error();
...
`), _ = o.stack.split(`
`), M = f.length - 1, R = _.length - 1; M >= 1 && R >= 0 && f[M] !== _[R]; )
            R--;
          for (; M >= 1 && R >= 0; M--, R--)
            if (f[M] !== _[R]) {
              if (M !== 1 || R !== 1)
...
` + f[M].replace(" at new ", " at ");
                    return e.displayName && V.includes("<anonymous>") && (V = V.replace("<anonymous>", e.displayName)), typeof e == "function" && f1.set(e, V), V;
                  }
                while (M >= 1 && R >= 0);
              break;
            }
        ...
        T1 = !1, b1.current = y, me(), Error.prepareStackTrace = v;
      }
      var Q = e ? e.displayName || e.name : "", G = Q ? u1(Q) : "";
      return typeof e == "function" && f1.set(e, G), G;
    }
    function ge(e, n, a) {
      return z1(e, !1);
    }
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          case p:
            return ge(e.render);
          case E:
            return p1(e.type, n, a);
          case k: {
            var o = e, v = o._payload, y = o._init;
            try {
              return p1(y(v), n, a);
            } catch {
            }
    ...
    var n1 = Object.prototype.hasOwnProperty, $1 = {}, N1 = B.ReactDebugCurrentFrame;
    function C1(e) {
      if (e) {
        var n = e._owner, a = p1(e.type, e._source, n ? n.type : null);
        N1.setExtraStackFrame(a);
      } else
        N1.setExtraStackFrame(null);
    }
    function we(e, n, a, o, v) {
      {
        var y = Function.call.bind(n1);
        for (var C in e)
          if (y(e, C)) {
            var f = void 0;
            try {
              ...
              f = e[C](n, C, o, a, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (M) {
              f = M;
            }
            f && !(f instanceof Error) && (C1(v), T("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", o || "React class", a, C, typeof f), C1(null)), f instanceof Error && !(f.message in $1) && ($1[f.message] = !0, C1(v), T("Failed %s type: %s", a, f.message), C1(null));
          }
      }
    }
    ...
    function U1(e) {
      if (be(e))
        return T("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Ee(e)), W1(e);
    }
    var a1 = B.ReactCurrentOwner, Me = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Re(e, n) {
      if (typeof e.ref == "string" && a1.current && n && a1.current.stateNode !== n) {
        var a = H(a1.current.type);
        R1[a] || (T('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', H(a1.current.type), e.ref), R1[a] = !0);
      }
    }
    function je(e, n) {
      {
        var a = function() {
          Y1 || (Y1 = !0, T("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", n));
        };
    ...
    function _e(e, n) {
      {
        var a = function() {
          G1 || (G1 = !0, T("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", n));
        };
    ...
    function ke(e, n, a, o, v) {
      {
        var y, C = {}, f = null, _ = null;
        a !== void 0 && (U1(a), f = "" + a), Le(n) && (U1(n.key), f = "" + n.key), Te(n) && (_ = n.ref, Re(n, v));
        for (y in n)
          n1.call(n, y) && !Me.hasOwnProperty(y) && (C[y] = n[y]);
        if (e && e.defaultProps) {
        ...
        return Se(e, f, _, v, o, a1.current, C);
      }
    }
    var j1 = B.ReactCurrentOwner, J1 = B.ReactDebugCurrentFrame;
    function X(e) {
      if (e) {
        var n = e._owner, a = p1(e.type, e._source, n ? n.type : null);
    ...
    function X1(e, n) {
      {
        ...
        K1[a] = !0;
        var o = "";
        e && e._owner && e._owner !== j1.current && (o = " It was passed a child from " + H(e._owner.type) + "."), X(e), T('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', a, o), X(null);
      }
    }
    function Q1(e, n) {
      {
        ...
        if (L1(e))
          ...
          if (typeof v == "function" && v !== e.entries)
            for (var y = v.call(e), C; !(C = y.next()).done; )
              S1(C.value) && X1(C.value, n);
        }
      }
    }
    function Ve(e) {
    ...
    function Ze(e) {
      {
        for (var n = Object.keys(e.props), a = 0; a < n.length; a++) {
          var o = n[a];
          if (o !== "children" && o !== "key") {
            X(e), T("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", o), X(null);
            break;
          }
        }
        e.ref !== null && (X(e), T("Invalid attribute `ref` supplied to `React.Fragment`."), X(null));
      }
    }
    var ee = {};
    function te(e, n, a, o, v, y) {
      {
        var C = c1(e);
        if (!C) {
          var f = "";
          ...
          _ ? f += _ : f += q1();
          var M;
          e === null ? M = "null" : L1(e) ? M = "array" : e !== void 0 && e.$$typeof === c ? (M = "<" + (H(e.type) || "Unknown") + " />", f = " Did you accidentally export a JSX literal instead of a component?") : M = typeof e, T("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", M, f);
        }
        var R = ke(e, n, a, v, y);
        if (R == null)
          return R;
        ...
        if (n1.call(n, "key")) {
          var G = H(e), F = Object.keys(n).filter(function(Ae) {
            return Ae !== "key";
          }), k1 = F.length > 0 ? "{key: someKey, " + F.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!ee[G + k1]) {
            var De = F.length > 0 ? "{" + F.join(": ..., ") + ": ...}" : "{}";
            T(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, k1, G, De, G), ee[G + k1] = !0;
          }
        }
        return e === d ? Ze(R) : Ve(R), R;
      }
    }
    function Pe(e, n, a) {
      return te(e, n, a, !0);
    ...
    var Oe = Be, Ie = Pe;
    l1.Fragment = d, l1.jsx = Oe, l1.jsxs = Ie;
  }()), l1;
}
var ie;
function t2() {
  return ie || (ie = 1, process.env.NODE_ENV === "production" ? m1.exports = Qe() : m1.exports = e2()), m1.exports;
}
var i = t2();
/**
...
const o1 = (t, c, m, d) => {
  const g = ze(
    ({ color: x = "currentColor", size: u = 24, stroke: s = 2, title: p, className: w, children: l, ...E }, k) => F1(
      "svg",
      {
        ref: k,
        ...r2[t],
        width: u,
        height: u,
        className: ["tabler-icon", `tabler-icon-${c}`, w].join(" "),
        strokeWidth: s,
        stroke: x,
        ...E
      },
      [
        p && F1("title", { key: "svg-title" }, p),
        ...d.map(([O, J]) => F1(O, J)),
        ...Array.isArray(l) ? l : [l]
      ]
    )
  );
  return g.displayName = `${m}`, g;
};
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
var n2 = o1("outline", "arrow-up", "IconArrowUp", [["path", { d: "M12 5l0 14", key: "svg-0" }], ["path", { d: "M18 11l-6 -6", key: "svg-1" }], ["path", { d: "M6 11l6 -6", key: "svg-2" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var a2 = o1("outline", "chevron-right", "IconChevronRight", [["path", { d: "M9 6l6 6l-6 6", key: "svg-0" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var i2 = o1("outline", "folder", "IconFolder", [["path", { d: "M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2", key: "svg-0" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var l2 = o1("outline", "search", "IconSearch", [["path", { d: "M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0", key: "svg-0" }], ["path", { d: "M21 21l-6 -6", key: "svg-1" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
...
function d2({ onSearch: t, onClose: c, locale: m }) {
  const [d, g] = W(""), x = y1("(max-width: 640px)");
  return /* @__PURE__ */ i.jsxs(
    A,
    {
      ...
      children: [
        /* @__PURE__ */ i.jsx(A, { mr: "xs", children: x ? /* @__PURE__ */ i.jsx(o2, {}) : m === "ru" ? /* @__PURE__ */ i.jsx(c2, {}) : /* @__PURE__ */ i.jsx(s2, {}) }),
        /* @__PURE__ */ i.jsx(
          We,
          {
            variant: "filled",
            ...
            value: d,
            leftSection: /* @__PURE__ */ i.jsx(l2, { stroke: 1.2 }),
            rightSectionProps: { style: { width: 110 } },
            rightSection: !!d && /* @__PURE__ */ i.jsxs(A, { gap: "xs", children: [
              /* @__PURE__ */ i.jsx(
                g1,
                {
                  variant: "transparent",
                  ...
                  children: /* @__PURE__ */ i.jsx(B1, { stroke: 1.2, size: 22 })
                }
              ),
              /* @__PURE__ */ i.jsx(
                H1,
            ...
            onKeyDown: (u) => u.key === "Enter" && t(d.trim())
          }
        ),
        /* @__PURE__ */ i.jsx(
          g1,
          {
            ...
            size: "lg",
            onClick: c,
            children: /* @__PURE__ */ i.jsx(B1, { size: 25, stroke: 1.2 })
          }
        )
      ]
    }
...
const ue = (t, c = 2, m) => {
  ...
  const d = 1024, g = c < 0 ? 0 : c, x = ["Б", "КБ", "МБ", "ГБ", "ТБ", "ПБ", "ЭБ", "ЗБ", "ЙБ"], u = ["B", "KB", "MB", "GB", "TB", "PB", "AB", "ZB"], s = Math.floor(Math.log(t) / Math.log(d));
  return `${parseFloat((t / Math.pow(d, s)).toFixed(g))} ${m === "en" ? u[s] : x[s]}`;
}, u2 = {
  pdf: {
    fileType: "pdf",
    documentType: "word",
  ...
  var d;
  const c = ((d = Object.values(u2).find((g) => g.mimeType === t)) == null ? void 0 : d.iconType) ?? "";
  if (!t) return /* @__PURE__ */ i.jsx(E2, { width: 20 });
  const m = b2[c];
  return m ? /* @__PURE__ */ i.jsx(m, { width: 20 }) : /* @__PURE__ */ i.jsx(x2, { width: 20 });
}, T2 = "_row_ddbp6_1", L2 = "_highlight_ddbp6_15", R2 = "_rowCheckbox_ddbp6_23", j2 = "_rowCheckboxVisible_ddbp6_31", _2 = "_rowName_ddbp6_49", S2 = "_table_ddbp6_59", e1 = {
  row: T2,
  highlight: L2,
  rowCheckbox: R2,
  rowCheckboxVisible: j2,
  rowName: _2,
  table: S2
};
function k2({
  ...
  const x = !!t.length && t.length === c.length, u = !x && !!c.length, s = (l) => c.includes(l), p = () => d(c.length ? [] : t.map((l) => l.Id)), w = (l) => d(
    c.includes(l) ? c.filter((E) => E !== l) : c.concat(l)
  );
    ...
    Z,
    {
      ...
      children: [
        /* @__PURE__ */ i.jsx(Z.Thead, { children: /* @__PURE__ */ i.jsxs(Z.Tr, { children: [
          /* @__PURE__ */ i.jsx(Z.Th, { c: "gray.6", fw: 500, fz: 10, tt: "uppercase", children: /* @__PURE__ */ i.jsxs(A, { gap: "xs", children: [
            /* @__PURE__ */ i.jsx(
              re,
              {
                size: "xs",
          ...
          /* @__PURE__ */ i.jsx(Z.Th, { c: "gray.6", fw: 500, fz: 10, tt: "uppercase", children: `${S(g, "ColumnChanged")}` }),
          /* @__PURE__ */ i.jsx(Z.Th, { c: "gray.6", fw: 500, fz: 10, tt: "uppercase", children: `${S(g, "ColumnSize")}` })
        ] }) }),
        /* @__PURE__ */ i.jsx(Z.Tbody, { children: t.map((l) => /* @__PURE__ */ i.jsxs(
          Z.Tr,
          {
            className: e1.row + (s(l.Id) ? ` ${e1.highlight}` : ""),
            onMouseDown: "MimeType" in l ? () => w(l.Id) : void 0,
            children: [
              /* @__PURE__ */ i.jsx(Z.Td, { fz: 13, children: /* @__PURE__ */ i.jsxs(A, { gap: "xs", styles: { root: { flexFlow: "noWrap" } }, children: [
                /* @__PURE__ */ i.jsx(V1, { h: 16, w: 16, children: "MimeType" in l && /* @__PURE__ */ i.jsx(
                  re,
                  {
                    readOnly: !0,
                    size: "xs",
                    checked: s(l.Id),
                    className: e1.rowCheckbox
                  }
                ) }),
                /* @__PURE__ */ i.jsxs(A, { gap: 10, styles: { root: { flexGrow: 1, flexWrap: "nowrap" } }, children: [
                  /* @__PURE__ */ i.jsx(
                    M2,
                    {
              ...
              /* @__PURE__ */ i.jsx(Z.Td, { fz: 12, c: "dimmed", children: "Size" in l ? isNaN(+l.Size) ? null : ue(+l.Size, 2, g || "ru") : "-" })
            ]
          },
          l.Id
        )) })
...
function F2({
  ...
  const x = v1(() => {
    ...
    if (s.length > oe) {
      const p = s.splice(1, s.length - oe);
      s.splice(1, 0, { id: 0, title: "...", type: 0, children: p });
    }
    return s;
  }, [t, c]);
  return /* @__PURE__ */ i.jsxs(A, { h: 48, py: 8, px: "lg", styles: { root: { flexShrink: 0 } }, children: [
    x.length > 1 && /* @__PURE__ */ i.jsx(
      g1,
      {
        ...
        ml: -2,
        onClick: m,
        children: /* @__PURE__ */ i.jsx(n2, { stroke: 1.2, size: 16 })
      }
    ),
    /* @__PURE__ */ i.jsx(
      Ue,
      {
        separatorMargin: 6,
        separator: /* @__PURE__ */ i.jsx(a2, { stroke: 1.2, size: 17 }),
        children: x.map(
          (u, s) => {
            var p;
            return u.children ? /* @__PURE__ */ i.jsxs(h1, { children: [
              /* @__PURE__ */ i.jsx(h1.Target, { children: /* @__PURE__ */ i.jsx(P1, { c: "dimmed", fz: 14, children: "..." }) }),
              /* @__PURE__ */ i.jsx(h1.Dropdown, { children: u.children.map((w) => {
                var l;
                return /* @__PURE__ */ i.jsx(
                  h1.Item,
                  {
                    c: "dark",
                    fz: 14,
                    leftSection: /* @__PURE__ */ i.jsx(i2, { stroke: 1.2, size: 18 }),
                    children: P != null && P.some((E) => E.type === w.type) ? S(g, ((l = P == null ? void 0 : P.find((E) => E.type === w.type)) == null ? void 0 : l.name) || "") : w.title
                  },
                  w.id
                );
              }) })
              ...
              {
                truncate: !0,
                underline: u.id !== 0 ? "hover" : "never",
                c: s === x.length - 1 ? "dark" : "dimmed",
                fz: 14,
                fw: s === x.length - 1 ? 500 : 400,
                maw: 200,
                onClick: u.id === 0 ? void 0 : () => d(u.id),
                children: P != null && P.some((w) => w.type === u.type) ? S(g, ((p = P == null ? void 0 : P.find((w) => w.type === u.type)) == null ? void 0 : p.name) || "") : u.title
              },
              s
            );
          }
...
var fe = /* @__PURE__ */ ((t) => (t[t.Docs = 16] = "Docs", t))(fe || {}), O1 = /* @__PURE__ */ ((t) => (t[t.Id = 0] = "Id", t[t.Name = 1] = "Name", t[t.Type = 2] = "Type", t[t.Size = 3] = "Size", t[t.Author = 4] = "Author", t[t.Date = 5] = "Date", t[t.UpdateDate = 6] = "UpdateDate", t))(O1 || {}), I1 = /* @__PURE__ */ ((t) => (t[t.Asc = 0] = "Asc", t[t.Desc = 1] = "Desc", t))(I1 || {});
const w1 = Ke.create({
  baseURL: "/api"
}), se = (t) => w1.get("v1/DocumentDirectory/Get", { params: t }), H2 = (t) => w1.get("v1/DocumentDirectory/Search", {
  params: { ...t, field: "All" }
});
function V2({
  enabledLinks: t,
  ...
  const p = y1("(max-width: 768px)"), w = y1("(max-width: 640px)");
  return /* @__PURE__ */ i.jsxs(i.Fragment, { children: [
    d && /* @__PURE__ */ i.jsx(A, { h: 61, bg: "yellow.4", px: "md", children: /* @__PURE__ */ i.jsx(Z1, { fz: 13, c: "dark.7", lh: 1.4, children: `${S(s, "MaxSizeLimitPartOne")} ${t ? S(s, "MaxSizeLimitPartTwo") : ""}` }) }),
    /* @__PURE__ */ i.jsxs(
      Ye,
      {
        direction: w ? "column" : "row",
        align: "center",
        justify: w ? "center" : "space-between",
        gap: 6,
        bg: "blue",
        c: "#fff",
        px: "md",
        ...
        w: "100%",
        children: [
          /* @__PURE__ */ i.jsxs(A, { gap: "xs", children: [
            /* @__PURE__ */ i.jsx(g1, { onClick: g, children: /* @__PURE__ */ i.jsx(B1, { size: 21, color: "#fff" }) }),
            /* @__PURE__ */ i.jsx(Z1, { fz: p ? 13 : 15, children: `${S(s, "FilesSelected")}: ${c} (${m})` })
          ] }),
          /* @__PURE__ */ i.jsxs(A, { gap: "xs", children: [
            /* @__PURE__ */ i.jsx(
              H1,
              {
                ...
                children: c === 1 ? S(s, "AttachFile") : S(s, "AttachFiles")
              }
            ),
            t && /* @__PURE__ */ i.jsx(
              H1,
              {
                ...
                variant: "default",
                onClick: u,
                children: c === 1 ? S(s, "AddLink") : S(s, "AddLinks")
              }
            )
          ] })
        ]
...
function A2({
  ...
  const [p, w] = W(ce), [l, E] = W(null), [k, O] = W(null), [J, s1] = W(!1), [$, B] = W([]), [T, q] = W([]), [x1, I] = W(!1), E1 = y1("(max-width: 640px)"), D = v1(() => k ? [...k.Directory.Items, ...k.Document.Items] : [...(l == null ? void 0 : l.Children) ?? [], ...(l == null ? void 0 : l.Documents) ?? []], [l, k]), U = v1(
    () => {
      let h = D.filter((b) => $.includes(b.Id));
      const L = h.map((b) => b.Id), j = T.filter((b) => !L.includes(b.Id));
      return j.length && (h = [...j, ...h]), h;
    },
    [D, $, T]
  ), t1 = v1(
    () => U.reduce((h, L) => h + L.Size, 0),
    [U]
  ), c1 = x + t1 > m, N = $e(
    async (h) => {
      I(!0);
      try {
        const { data: L } = await se(h);
        E(L[0]), O(null);
      } finally {
        I(!1);
      }
    ...
    try {
      const K = (await Promise.all(
        h.map(
          (Y) => w1.get(`/v1/Documents/Download?id=${Y.Id}&download=false`, {
            responseType: "blob"
          })
        )
      )).map(
        (Y, r1) => new File([Y.data], h[r1].Name, {
          type: Y.headers["content-type"] ?? h[r1].MimeType
        })
      );
      B([]), q([]), g(K), d();
    } catch (b) {
      Xe(b) && console.error(
        ((j = (L = b.response) == null ? void 0 : L.data) == null ? void 0 : j.ErrorMessage) ?? "Неизвестная ошибка"
      );
    } finally {
      I(!1);
    }
  ...
  return Ne(() => {
    if (t)
      return (async () => {
        ...
        w(ce), E(null), O(null), B([]), q([]);
      };
  }, [t, N]), /* @__PURE__ */ i.jsx(Ge, { theme: { fontFamily: "Roboto, sans-serif" }, children: /* @__PURE__ */ i.jsx(
    Je,
    {
      centered: !0,
      withCloseButton: !1,
      ...
      padding: 0,
      onClose: d,
      children: /* @__PURE__ */ i.jsxs(V1, { h: 590, pos: "relative", children: [
        /* @__PURE__ */ i.jsx(qe, { visible: x1 }),
        /* @__PURE__ */ i.jsx(d2, { onSearch: d1, onClose: d, locale: s }),
        /* @__PURE__ */ i.jsx(
          F2,
          {
            directory: l,
        ...
        /* @__PURE__ */ i.jsx(
          ...
          {
            style: {
              height: `calc(100% - 48px - 64px - ${$.length ? 76 : 0}px  + ${E1 ? 16 : 0}px - ${c1 ? 61 : 0}px)`
            },
            children: /* @__PURE__ */ i.jsx(
              k2,
              {
                rows: D,
                selectedRowIds: $,
                onOpenDir: (h) => N({ ...p, id: h }),
                onSelect: (h) => {
                  B(h);
                  const L = D == null ? void 0 : D.map((b) => b.Id), j = T.filter((b) => !L.includes(b.Id));
                  q(j != null && j.length ? [...j, ...D.filter((b) => h.includes(b.Id))] : D.filter((b) => h.includes(b.Id)));
                },
                locale: s
              }
            )
