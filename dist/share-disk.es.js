...
import oe, { forwardRef as Ze, createElement as j1, useState as A, useMemo as f1, useCallback as Be, useEffect as ze } from "react";
import { Group as P, TextInput as Ae, ActionIcon as d1, Button as M1, Table as F, Checkbox as ee, Box as L1, Text as S1, Anchor as k1, Breadcrumbs as Ne, Menu as c1, Flex as We, MantineProvider as $e, Modal as Ue, LoadingOverlay as Ye } from "@mantine/core";
import Je, { isAxiosError as Ge } from "axios";
import { useMediaQuery as p1 } from "@mantine/hooks";
var u1 = { exports: {} }, Q = {};
/**
 * @license React
...
function qe() {
  if (te) return Q;
  te = 1;
  var t = oe, u = Symbol.for("react.element"), v = Symbol.for("react.fragment"), d = Object.prototype.hasOwnProperty, h = t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, f = { key: !0, ref: !0, __self: !0, __source: !0 };
  function C(w, g, l) {
    var x, _ = {}, S = null, V = null;
    l !== void 0 && (S = "" + l), g.key !== void 0 && (S = "" + g.key), g.ref !== void 0 && (V = g.ref);
    for (x in g) d.call(g, x) && !f.hasOwnProperty(x) && (_[x] = g[x]);
    if (w && w.defaultProps) for (x in g = w.defaultProps, g) _[x] === void 0 && (_[x] = g[x]);
    return { $$typeof: u, type: w, key: S, ref: V, props: _, _owner: h.current };
  }
  return Q.Fragment = v, Q.jsx = C, Q.jsxs = C, Q;
}
var e1 = {};
/**
 * @license React
...
function Ke() {
  return re || (re = 1, process.env.NODE_ENV !== "production" && function() {
    var t = oe, u = Symbol.for("react.element"), v = Symbol.for("react.portal"), d = Symbol.for("react.fragment"), h = Symbol.for("react.strict_mode"), f = Symbol.for("react.profiler"), C = Symbol.for("react.provider"), w = Symbol.for("react.context"), g = Symbol.for("react.forward_ref"), l = Symbol.for("react.suspense"), x = Symbol.for("react.suspense_list"), _ = Symbol.for("react.memo"), S = Symbol.for("react.lazy"), V = Symbol.for("react.offscreen"), Z = Symbol.iterator, O = "@@iterator";
    function N(e) {
    ...
    function C1(e, r, a) {
      {
        var o = I.ReactDebugCurrentFrame, p = o.getStackAddendum();
        p !== "" && (r += "%s", a = a.concat([p]));
        var m = a.map(function(c) {
          return String(c);
        });
        m.unshift("Warning: " + r), Function.prototype.apply.call(console[e], console, m);
      }
    }
    var W = !1, $ = !1, r1 = !1, n1 = !1, D = !1, a1;
    a1 = Symbol.for("react.module.reference");
    function m1(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === d || e === f || D || e === h || e === l || e === x || n1 || e === V || W || $ || r1 || typeof e == "object" && e !== null && (e.$$typeof === S || e.$$typeof === _ || e.$$typeof === C || e.$$typeof === w || e.$$typeof === g || // This needs to include all possible module reference object
    ...
    var k = Object.assign, M = 0, U, B, q, O1, V1, I1, D1;
    function Z1() {
    }
    ...
    function de() {
      {
        if (M === 0) {
          U = console.log, B = console.info, q = console.warn, O1 = console.error, V1 = console.group, I1 = console.groupCollapsed, D1 = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: Z1,
    ...
    var g1 = I.ReactCurrentDispatcher, w1;
    function i1(e, r, a) {
      {
        if (w1 === void 0)
          try {
...
` + w1 + e;
    ...
    function B1(e, r) {
      ...
      var m;
      m = g1.current, g1.current = null, de();
      try {
        if (r) {
          var c = function() {
            throw Error();
...
`), j = o.stack.split(`
`), T = s.length - 1, R = j.length - 1; T >= 1 && R >= 0 && s[T] !== j[R]; )
            R--;
          for (; T >= 1 && R >= 0; T--, R--)
            if (s[T] !== j[R]) {
              if (T !== 1 || R !== 1)
...
` + s[T].replace(" at new ", " at ");
                    return e.displayName && H.includes("<anonymous>") && (H = H.replace("<anonymous>", e.displayName)), typeof e == "function" && l1.set(e, H), H;
                  }
                while (T >= 1 && R >= 0);
              break;
            }
        ...
        x1 = !1, g1.current = m, pe(), Error.prepareStackTrace = p;
      }
      var J = e ? e.displayName || e.name : "", z = J ? i1(J) : "";
      return typeof e == "function" && l1.set(e, z), z;
    }
    function Ce(e, r, a) {
      return B1(e, !1);
    }
    ...
    var K = Object.prototype.hasOwnProperty, z1 = {}, A1 = I.ReactDebugCurrentFrame;
    function s1(e) {
      if (e) {
        var r = e._owner, a = o1(e.type, e._source, r ? r.type : null);
        A1.setExtraStackFrame(a);
      } else
        A1.setExtraStackFrame(null);
    }
    function ve(e, r, a, o, p) {
      {
          ...
          if (m(e, c)) {
            ...
            try {
              if (typeof e[c] != "function") {
                var j = Error((o || "React class") + ": " + a + " type `" + c + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof e[c] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw j.name = "Invariant Violation", j;
              }
              s = e[c](r, c, o, a, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (T) {
              s = T;
            }
            s && !(s instanceof Error) && (s1(p), y("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", o || "React class", a, c, typeof s), s1(null)), s instanceof Error && !(s.message in z1) && (z1[s.message] = !0, s1(p), y("Failed %s type: %s", a, s.message), s1(null));
          }
      }
    }
    ...
    function W1(e) {
      if (xe(e))
        return y("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", we(e)), N1(e);
    }
    var X = I.ReactCurrentOwner, ye = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Te(e, r) {
      if (typeof e.ref == "string" && X.current && r && X.current.stateNode !== r) {
        var a = b(X.current.type);
        E1[a] || (y('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', b(X.current.type), e.ref), E1[a] = !0);
      }
    }
    function Re(e, r) {
      {
        var a = function() {
          $1 || ($1 = !0, y("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
    ...
    function _e(e, r) {
      {
        var a = function() {
          U1 || (U1 = !0, y("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
    ...
    function Me(e, r, a, o, p) {
      {
        var m, c = {}, s = null, j = null;
        a !== void 0 && (W1(a), s = "" + a), be(r) && (W1(r.key), s = "" + r.key), Ee(r) && (j = r.ref, Te(r, p));
        for (m in r)
          K.call(r, m) && !ye.hasOwnProperty(m) && (c[m] = r[m]);
        if (e && e.defaultProps) {
        ...
        return je(e, s, j, p, o, X.current, c);
      }
    }
    var b1 = I.ReactCurrentOwner, Y1 = I.ReactDebugCurrentFrame;
    function Y(e) {
      if (e) {
        var r = e._owner, a = o1(e.type, e._source, r ? r.type : null);
    ...
    function q1(e, r) {
      {
        ...
        G1[a] = !0;
        var o = "";
        e && e._owner && e._owner !== b1.current && (o = " It was passed a child from " + b(e._owner.type) + "."), Y(e), y('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', a, o), Y(null);
      }
    }
    function K1(e, r) {
      {
    ...
    function He(e) {
      {
        for (var r = Object.keys(e.props), a = 0; a < r.length; a++) {
          var o = r[a];
          if (o !== "children" && o !== "key") {
            Y(e), y("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", o), Y(null);
            break;
          }
        }
    ...
    function Q1(e, r, a, o, p, m) {
      {
        ...
        if (!c) {
          ...
          j ? s += j : s += J1();
          var T;
          e === null ? T = "null" : y1(e) ? T = "array" : e !== void 0 && e.$$typeof === u ? (T = "<" + (b(e.type) || "Unknown") + " />", s = " Did you accidentally export a JSX literal instead of a component?") : T = typeof e, y("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", T, s);
        }
        var R = Me(e, r, a, p, m);
        if (R == null)
          return R;
        ...
        if (K.call(r, "key")) {
          var z = b(e), L = Object.keys(r).filter(function(De) {
            return De !== "key";
          }), _1 = L.length > 0 ? "{key: someKey, " + L.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!X1[z + _1]) {
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, _1, z, Ie, z), X1[z + _1] = !0;
          }
        }
        return e === d ? He(R) : ke(R), R;
      }
    }
    function Fe(e, r, a) {
      return Q1(e, r, a, !0);
    ...
    var Oe = Pe, Ve = Fe;
    e1.Fragment = d, e1.jsx = Oe, e1.jsxs = Ve;
  }()), e1;
}
var ne;
function Xe() {
  return ne || (ne = 1, process.env.NODE_ENV === "production" ? u1.exports = qe() : u1.exports = Ke()), u1.exports;
}
var i = Xe();
/**
...
const t1 = (t, u, v, d) => {
  const h = Ze(
    ({ color: f = "currentColor", size: C = 24, stroke: w = 2, title: g, className: l, children: x, ..._ }, S) => j1(
      "svg",
      {
        ref: S,
        ...Qe[t],
        width: C,
        height: C,
        className: ["tabler-icon", `tabler-icon-${u}`, l].join(" "),
        strokeWidth: w,
        stroke: f,
        ..._
      },
      [
        g && j1("title", { key: "svg-title" }, g),
        ...d.map(([V, Z]) => j1(V, Z)),
        ...Array.isArray(x) ? x : [x]
      ]
    )
  );
  return h.displayName = `${v}`, h;
};
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
var e2 = t1("outline", "arrow-up", "IconArrowUp", [["path", { d: "M12 5l0 14", key: "svg-0" }], ["path", { d: "M18 11l-6 -6", key: "svg-1" }], ["path", { d: "M6 11l6 -6", key: "svg-2" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var t2 = t1("outline", "chevron-right", "IconChevronRight", [["path", { d: "M9 6l6 6l-6 6", key: "svg-0" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var r2 = t1("outline", "folder", "IconFolder", [["path", { d: "M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2", key: "svg-0" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var n2 = t1("outline", "search", "IconSearch", [["path", { d: "M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0", key: "svg-0" }], ["path", { d: "M21 21l-6 -6", key: "svg-1" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var H1 = t1("outline", "x", "IconX", [["path", { d: "M18 6l-12 12", key: "svg-0" }], ["path", { d: "M6 6l12 12", key: "svg-1" }]]);
...
function l2({ onSearch: t, onClose: u }) {
  const [v, d] = A(""), h = p1("(max-width: 640px)");
  return /* @__PURE__ */ i.jsxs(
    P,
    {
      ...
      children: [
        /* @__PURE__ */ i.jsx(P, { mr: "xs", children: h ? /* @__PURE__ */ i.jsx(a2, {}) : /* @__PURE__ */ i.jsx(i2, {}) }),
        /* @__PURE__ */ i.jsx(
          Ae,
          {
            variant: "filled",
            ...
            rightSection: !!v && /* @__PURE__ */ i.jsxs(P, { gap: "xs", children: [
              /* @__PURE__ */ i.jsx(
                d1,
                {
                  variant: "transparent",
                  ...
                  children: /* @__PURE__ */ i.jsx(H1, { stroke: 1.2, size: 22 })
                }
              ),
              /* @__PURE__ */ i.jsx(
                M1,
            ...
            onKeyDown: (f) => f.key === "Enter" && t(v.trim())
          }
        ),
        /* @__PURE__ */ i.jsx(
          d1,
          {
            ...
            size: "lg",
            onClick: u,
            children: /* @__PURE__ */ i.jsx(H1, { size: 25, stroke: 1.2 })
          }
        )
      ]
    }
...
const se = (t, u = 2) => {
  if (!+t) return "0 Б";
  const v = 1024, d = u < 0 ? 0 : u, h = ["Б", "КБ", "МБ", "ГБ", "ТБ", "ПБ", "ЭБ", "ЗБ", "ЙБ"], f = Math.floor(Math.log(t) / Math.log(v));
  return `${parseFloat((t / Math.pow(v, f)).toFixed(d))} ${h[f]}`;
}, o2 = {
  pdf: {
    fileType: "pdf",
    documentType: "word",
  ...
  var d;
  const u = ((d = Object.values(o2).find((h) => h.mimeType === t)) == null ? void 0 : d.iconType) ?? "";
  if (!t) return /* @__PURE__ */ i.jsx(g2, { width: 20 });
  const v = w2[u];
  return v ? /* @__PURE__ */ i.jsx(v, { width: 20 }) : /* @__PURE__ */ i.jsx(v2, { width: 20 });
}, y2 = "_row_ddbp6_1", E2 = "_highlight_ddbp6_15", b2 = "_rowCheckbox_ddbp6_23", T2 = "_rowCheckboxVisible_ddbp6_31", R2 = "_rowName_ddbp6_49", _2 = "_table_ddbp6_59", G = {
  row: y2,
  highlight: E2,
  rowCheckbox: b2,
...
function j2({
  ...
  const h = !!t.length && t.length === u.length, f = !h && !!u.length, C = (l) => u.includes(l), w = () => d(u.length ? [] : t.map((l) => l.Id)), g = (l) => d(
    u.includes(l) ? u.filter((x) => x !== l) : u.concat(l)
  );
    ...
    F,
    {
      ...
      children: [
        /* @__PURE__ */ i.jsx(F.Thead, { children: /* @__PURE__ */ i.jsxs(F.Tr, { children: [
          /* @__PURE__ */ i.jsx(F.Th, { c: "gray.6", fw: 500, fz: 10, tt: "uppercase", children: /* @__PURE__ */ i.jsxs(P, { gap: "xs", children: [
            /* @__PURE__ */ i.jsx(
              ee,
              {
                size: "xs",
        ...
        /* @__PURE__ */ i.jsx(F.Tbody, { children: t.map((l) => /* @__PURE__ */ i.jsxs(
          F.Tr,
          {
            className: G.row + (C(l.Id) ? ` ${G.highlight}` : ""),
            onMouseDown: "MimeType" in l ? () => g(l.Id) : void 0,
            children: [
              /* @__PURE__ */ i.jsx(F.Td, { fz: 13, children: /* @__PURE__ */ i.jsxs(P, { gap: "xs", styles: { root: { flexFlow: "noWrap" } }, children: [
                /* @__PURE__ */ i.jsx(L1, { h: 16, w: 16, children: "MimeType" in l && /* @__PURE__ */ i.jsx(
                  ee,
                  {
                    readOnly: !0,
                    size: "xs",
                    checked: C(l.Id),
                    className: G.rowCheckbox
                  }
                ) }),
                /* @__PURE__ */ i.jsxs(P, { gap: 10, styles: { root: { flexGrow: 1, flexWrap: "nowrap" } }, children: [
                  /* @__PURE__ */ i.jsx(
                    x2,
                    {
              ...
              /* @__PURE__ */ i.jsx(F.Td, { fz: 12, c: "dimmed", children: /* @__PURE__ */ i.jsx("span", { title: new Date(l.Timestamp).toLocaleString("ru-Ru"), children: new Date(l.Timestamp).toLocaleString("ru-Ru") }) }),
              /* @__PURE__ */ i.jsx(F.Td, { fz: 12, c: "dimmed", children: "Size" in l ? isNaN(+l.Size) ? null : se(+l.Size) : "-" })
            ]
          },
          l.Id
        )) })
...
function M2({
  ...
  const h = f1(() => {
    ...
    if (C.length > ae) {
      const w = C.splice(1, C.length - ae);
      C.splice(1, 0, { id: 0, title: "...", children: w });
    }
    return C;
  }, [t, u]);
  return /* @__PURE__ */ i.jsxs(P, { h: 48, py: 8, px: "lg", styles: { root: { flexShrink: 0 } }, children: [
    h.length > 1 && /* @__PURE__ */ i.jsx(
      d1,
      {
        variant: "subtle",
        color: "dimmed",
    ...
    /* @__PURE__ */ i.jsx(
      Ne,
      {
        ...
        children: h.map(
          (f, C) => f.children ? /* @__PURE__ */ i.jsxs(c1, { children: [
            /* @__PURE__ */ i.jsx(c1.Target, { children: /* @__PURE__ */ i.jsx(k1, { c: "dimmed", fz: 14, children: "..." }) }),
            /* @__PURE__ */ i.jsx(c1.Dropdown, { children: f.children.map((w) => /* @__PURE__ */ i.jsx(
              c1.Item,
              {
                c: "dark",
                fz: 14,
            ...
            k1,
            {
              ...
              c: C === h.length - 1 ? "dark" : "dimmed",
              fz: 14,
              fw: C === h.length - 1 ? 500 : 400,
              maw: 200,
              onClick: f.id === 0 ? void 0 : () => d(f.id),
              children: f.title
            },
            C
          )
...
var ce = /* @__PURE__ */ ((t) => (t[t.Docs = 16] = "Docs", t))(ce || {}), F1 = /* @__PURE__ */ ((t) => (t[t.Id = 0] = "Id", t[t.Name = 1] = "Name", t[t.Type = 2] = "Type", t[t.Size = 3] = "Size", t[t.Author = 4] = "Author", t[t.Date = 5] = "Date", t[t.UpdateDate = 6] = "UpdateDate", t))(F1 || {}), P1 = /* @__PURE__ */ ((t) => (t[t.Asc = 0] = "Asc", t[t.Desc = 1] = "Desc", t))(P1 || {});
const h1 = Je.create({
  baseURL: "/api"
}), ie = (t) => h1.get("v1/DocumentDirectory/Get", { params: t }), L2 = (t) => h1.get("v1/DocumentDirectory/Search", {
  params: { ...t, field: "All" }
});
function S2({
  enabledLinks: t,
  ...
  const w = p1("(max-width: 768px)"), g = p1("(max-width: 640px)");
  return /* @__PURE__ */ i.jsxs(i.Fragment, { children: [
    d && /* @__PURE__ */ i.jsx(P, { h: 61, bg: "yellow.4", px: "md", children: /* @__PURE__ */ i.jsx(S1, { fz: 13, c: "dark.7", lh: 1.4, children: `Общий объем отправляемых файлов превышает действующее ограничение
            (25 МБ). ${t ? "Файлы можно отправить в виде ссылок на Р7-Диск." : ""}` }) }),
    /* @__PURE__ */ i.jsxs(
      We,
      {
        ...
        w: "100%",
        children: [
          /* @__PURE__ */ i.jsxs(P, { gap: "xs", children: [
            /* @__PURE__ */ i.jsx(d1, { onClick: h, children: /* @__PURE__ */ i.jsx(H1, { size: 21, color: "#fff" }) }),
            /* @__PURE__ */ i.jsxs(S1, { fz: w ? 13 : 15, children: [
              "Выбрано файлов: ",
              u,
              " (",
              v,
          ...
          /* @__PURE__ */ i.jsxs(P, { gap: "xs", children: [
            /* @__PURE__ */ i.jsx(
              M1,
              {
                ...
                children: u === 1 ? "Прикрепить файл" : "Прикрепить файлы"
              }
            ),
            /* @__PURE__ */ i.jsx(
              M1,
              {
                ...
                variant: "default",
                onClick: C,
                children: u === 1 ? "Добавить ссылку" : "Добавить ссылки"
              }
            )
          ] })
        ]
...
function I2({
  opened: t,
  enabledLinks: u = !1,
  maxSizeAttachments: v = k2,
  onClose: d,
  onAttachFiles: h,
  offsetSize: f = 0,
  onCreateLink: C
}) {
  const [w, g] = A(le), [l, x] = A(null), [_, S] = A(null), [V, Z] = A(!1), [O, N] = A([]), [I, y] = A(!1), C1 = p1("(max-width: 640px)"), W = f1(() => _ ? [..._.Directory.Items, ..._.Document.Items] : [...(l == null ? void 0 : l.Children) ?? [], ...(l == null ? void 0 : l.Documents) ?? []], [l, _]), $ = f1(
    () => W.filter((E) => O.includes(E.Id)),
    [W, O]
  ), r1 = f1(
    () => $.reduce((E, b) => E + b.Size, 0),
    [$]
  ), n1 = f + r1 > v, D = Be(
    async (E) => {
      y(!0);
      try {
        const { data: b } = await ie(E);
        x(b[0]), S(null);
      } finally {
        y(!1);
      }
    ...
    try {
      const U = (await Promise.all(
        E.map(
          (B) => h1.get(`/v1/Documents/Download?id=${B.Id}&download=false`, {
            responseType: "blob"
          })
        )
      )).map(
        (B, q) => new File([B.data], E[q].Name, {
          type: B.headers["content-type"] ?? E[q].MimeType
        })
      );
      N([]), h(U), d();
    } catch (M) {
      Ge(M) && console.error(
        ((k = (b = M.response) == null ? void 0 : b.data) == null ? void 0 : k.ErrorMessage) ?? "Неизвестная ошибка"
      );
    } finally {
      y(!1);
    }
  ...
  return ze(() => {
    if (t)
      return (async () => {
        ...
        g(le), x(null), S(null), N([]);
      };
  }, [t, D]), /* @__PURE__ */ i.jsx($e, { theme: { fontFamily: "Roboto, sans-serif" }, children: /* @__PURE__ */ i.jsx(
    Ue,
    {
      centered: !0,
      withCloseButton: !1,
      ...
      padding: 0,
      onClose: d,
      children: /* @__PURE__ */ i.jsxs(L1, { h: 590, pos: "relative", children: [
        /* @__PURE__ */ i.jsx(Ye, { visible: I }),
        /* @__PURE__ */ i.jsx(l2, { onSearch: a1, onClose: d }),
        /* @__PURE__ */ i.jsx(
          M2,
          {
            directory: l,
        ...
        /* @__PURE__ */ i.jsx(
          ...
          {
            style: {
              height: `calc(100% - 48px - 64px - ${O.length ? 76 : 0}px  + ${C1 ? 16 : 0}px - ${n1 ? 61 : 0}px)`
            },
            children: /* @__PURE__ */ i.jsx(
              j2,
              {
                rows: W,
                selectedRowIds: O,
                onOpenDir: (E) => D({ ...w, id: E }),
                onSelect: (E) => N(E)
              }
            )
          }
        ),
        !!O.length && /* @__PURE__ */ i.jsx(
          S2,
          {
            enabledLinks: u,
            count: O.length,
