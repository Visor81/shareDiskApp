...
import oe, { forwardRef as Ze, createElement as L1, useState as A, useMemo as p1, useCallback as Be, useEffect as ze } from "react";
import { Group as D, TextInput as Ae, ActionIcon as h1, Button as S1, Table as P, Checkbox as ee, Box as k1, Text as H1, Anchor as F1, Breadcrumbs as Ne, Menu as d1, Flex as We, MantineProvider as $e, Modal as Ue, LoadingOverlay as Ye } from "@mantine/core";
import Je, { isAxiosError as Ge } from "axios";
import { useMediaQuery as C1 } from "@mantine/hooks";
var f1 = { exports: {} }, r1 = {};
/**
 * @license React
...
function qe() {
  if (te) return r1;
  te = 1;
  var t = oe, d = Symbol.for("react.element"), g = Symbol.for("react.fragment"), p = Object.prototype.hasOwnProperty, C = t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, f = { key: !0, ref: !0, __self: !0, __source: !0 };
  function m(x, w, l) {
    var y, j = {}, k = null, Z = null;
    l !== void 0 && (k = "" + l), w.key !== void 0 && (k = "" + w.key), w.ref !== void 0 && (Z = w.ref);
    for (y in w) p.call(w, y) && !f.hasOwnProperty(y) && (j[y] = w[y]);
    if (x && x.defaultProps) for (y in w = x.defaultProps, w) j[y] === void 0 && (j[y] = w[y]);
    return { $$typeof: d, type: x, key: k, ref: Z, props: j, _owner: C.current };
  }
  return r1.Fragment = g, r1.jsx = m, r1.jsxs = m, r1;
}
var n1 = {};
/**
 * @license React
...
function Ke() {
  return re || (re = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var O = !1, g1 = !1, V = !1, W = !1, i1 = !1, X;
    X = Symbol.for("react.module.reference");
    function z(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === p || e === f || i1 || e === C || e === l || e === y || W || e === Z || O || g1 || V || typeof e == "object" && e !== null && (e.$$typeof === k || e.$$typeof === j || e.$$typeof === m || e.$$typeof === x || e.$$typeof === w || // This needs to include all possible module reference object
    ...
    function H(e) {
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          ...
          case k: {
            var h = e, v = h._payload, u = h._init;
            try {
              return H(u(v));
            } catch {
              return null;
    ...
    var c = Object.assign, E = 0, M, b, J, $, Q, V1, D1;
    function Z1() {
    }
    ...
    function fe() {
      {
        if (E === 0) {
          M = console.log, b = console.info, J = console.warn, $ = console.error, Q = console.group, V1 = console.groupCollapsed, D1 = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: Z1,
    ...
    var x1 = I.ReactCurrentDispatcher, y1;
    function o1(e, r, a) {
      {
        if (y1 === void 0)
          try {
...
` + y1 + e;
    ...
    function B1(e, r) {
      ...
      var v;
      v = x1.current, x1.current = null, fe();
      try {
        if (r) {
          var u = function() {
            throw Error();
...
`), L = o.stack.split(`
`), R = s.length - 1, _ = L.length - 1; R >= 1 && _ >= 0 && s[R] !== L[_]; )
            _--;
          for (; R >= 1 && _ >= 0; R--, _--)
            if (s[R] !== L[_]) {
              if (R !== 1 || _ !== 1)
...
` + s[R].replace(" at new ", " at ");
                    return e.displayName && F.includes("<anonymous>") && (F = F.replace("<anonymous>", e.displayName)), typeof e == "function" && s1.set(e, F), F;
                  }
                while (R >= 1 && _ >= 0);
              break;
            }
        ...
        E1 = !1, x1.current = v, pe(), Error.prepareStackTrace = h;
      }
      var q = e ? e.displayName || e.name : "", U = q ? o1(q) : "";
      return typeof e == "function" && s1.set(e, U), U;
    }
    function Ce(e, r, a) {
      return B1(e, !1);
    }
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          case w:
            return Ce(e.render);
          case j:
            return c1(e.type, r, a);
          case k: {
            var o = e, h = o._payload, v = o._init;
            try {
              return c1(v(h), r, a);
            } catch {
            }
    ...
    var e1 = Object.prototype.hasOwnProperty, z1 = {}, A1 = I.ReactDebugCurrentFrame;
    function u1(e) {
      if (e) {
        var r = e._owner, a = c1(e.type, e._source, r ? r.type : null);
        A1.setExtraStackFrame(a);
      } else
        A1.setExtraStackFrame(null);
    }
    function ve(e, r, a, o, h) {
      {
          ...
          if (v(e, u)) {
            ...
            try {
              if (typeof e[u] != "function") {
                var L = Error((o || "React class") + ": " + a + " type `" + u + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof e[u] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw L.name = "Invariant Violation", L;
              }
              s = e[u](r, u, o, a, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (R) {
              s = R;
            }
            s && !(s instanceof Error) && (u1(h), T("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", o || "React class", a, u, typeof s), u1(null)), s instanceof Error && !(s.message in z1) && (z1[s.message] = !0, u1(h), T("Failed %s type: %s", a, s.message), u1(null));
          }
      }
    }
    ...
    function Te(e, r) {
      if (typeof e.ref == "string" && t1.current && r && t1.current.stateNode !== r) {
        var a = H(t1.current.type);
        T1[a] || (T('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', H(t1.current.type), e.ref), T1[a] = !0);
      }
    }
    function Re(e, r) {
      {
    ...
    function Me(e, r, a, o, h) {
      {
        var v, u = {}, s = null, L = null;
        a !== void 0 && (W1(a), s = "" + a), be(r) && (W1(r.key), s = "" + r.key), Ee(r) && (L = r.ref, Te(r, h));
        for (v in r)
          e1.call(r, v) && !ye.hasOwnProperty(v) && (u[v] = r[v]);
        if (e && e.defaultProps) {
        ...
        return je(e, s, L, h, o, t1.current, u);
      }
    }
    var R1 = I.ReactCurrentOwner, Y1 = I.ReactDebugCurrentFrame;
    function G(e) {
      if (e) {
        var r = e._owner, a = c1(e.type, e._source, r ? r.type : null);
    ...
    function q1(e, r) {
      {
        ...
        G1[a] = !0;
        var o = "";
        e && e._owner && e._owner !== R1.current && (o = " It was passed a child from " + H(e._owner.type) + "."), G(e), T('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', a, o), G(null);
      }
    }
    function K1(e, r) {
      {
        ...
        if (b1(e))
          ...
          if (typeof h == "function" && h !== e.entries)
            for (var v = h.call(e), u; !(u = v.next()).done; )
              j1(u.value) && q1(u.value, r);
        }
      }
    }
    function ke(e) {
    ...
    function He(e) {
      {
        for (var r = Object.keys(e.props), a = 0; a < r.length; a++) {
          var o = r[a];
          if (o !== "children" && o !== "key") {
            G(e), T("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", o), G(null);
            break;
          }
        }
        e.ref !== null && (G(e), T("Invalid attribute `ref` supplied to `React.Fragment`."), G(null));
      }
    }
    var X1 = {};
    function Q1(e, r, a, o, h, v) {
      {
        var u = z(e);
        if (!u) {
          var s = "";
          ...
          L ? s += L : s += J1();
          var R;
          e === null ? R = "null" : b1(e) ? R = "array" : e !== void 0 && e.$$typeof === d ? (R = "<" + (H(e.type) || "Unknown") + " />", s = " Did you accidentally export a JSX literal instead of a component?") : R = typeof e, T("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", R, s);
        }
        var _ = Me(e, r, a, h, v);
        if (_ == null)
          return _;
        ...
        if (e1.call(r, "key")) {
          var U = H(e), S = Object.keys(r).filter(function(De) {
            return De !== "key";
          }), M1 = S.length > 0 ? "{key: someKey, " + S.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!X1[U + M1]) {
            var Ve = S.length > 0 ? "{" + S.join(": ..., ") + ": ...}" : "{}";
            T(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, M1, U, Ve, U), X1[U + M1] = !0;
          }
        }
        return e === p ? He(_) : ke(_), _;
      }
    }
    function Fe(e, r, a) {
      return Q1(e, r, a, !0);
    ...
    var Ie = Pe, Oe = Fe;
    n1.Fragment = p, n1.jsx = Ie, n1.jsxs = Oe;
  }()), n1;
}
var ne;
function Xe() {
  return ne || (ne = 1, process.env.NODE_ENV === "production" ? f1.exports = qe() : f1.exports = Ke()), f1.exports;
}
var i = Xe();
/**
...
const a1 = (t, d, g, p) => {
  const C = Ze(
    ({ color: f = "currentColor", size: m = 24, stroke: x = 2, title: w, className: l, children: y, ...j }, k) => L1(
      "svg",
      {
        ref: k,
        ...Qe[t],
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
var e2 = a1("outline", "arrow-up", "IconArrowUp", [["path", { d: "M12 5l0 14", key: "svg-0" }], ["path", { d: "M18 11l-6 -6", key: "svg-1" }], ["path", { d: "M6 11l6 -6", key: "svg-2" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var t2 = a1("outline", "chevron-right", "IconChevronRight", [["path", { d: "M9 6l6 6l-6 6", key: "svg-0" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var r2 = a1("outline", "folder", "IconFolder", [["path", { d: "M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2", key: "svg-0" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var n2 = a1("outline", "search", "IconSearch", [["path", { d: "M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0", key: "svg-0" }], ["path", { d: "M21 21l-6 -6", key: "svg-1" }]]);
/**
 * @license @tabler/icons-react v3.24.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
var P1 = a1("outline", "x", "IconX", [["path", { d: "M18 6l-12 12", key: "svg-0" }], ["path", { d: "M6 6l12 12", key: "svg-1" }]]);
...
function l2({ onSearch: t, onClose: d }) {
  const [g, p] = A(""), C = C1("(max-width: 640px)");
  return /* @__PURE__ */ i.jsxs(
    D,
    {
      ...
      children: [
        /* @__PURE__ */ i.jsx(D, { mr: "xs", children: C ? /* @__PURE__ */ i.jsx(a2, {}) : /* @__PURE__ */ i.jsx(i2, {}) }),
        /* @__PURE__ */ i.jsx(
          Ae,
          {
            variant: "filled",
            ...
            rightSection: !!g && /* @__PURE__ */ i.jsxs(D, { gap: "xs", children: [
              /* @__PURE__ */ i.jsx(
                h1,
                {
                  variant: "transparent",
...
const se = (t, d = 2) => {
  if (!+t) return "0 Б";
  const g = 1024, p = d < 0 ? 0 : d, C = ["Б", "КБ", "МБ", "ГБ", "ТБ", "ПБ", "ЭБ", "ЗБ", "ЙБ"], f = Math.floor(Math.log(t) / Math.log(g));
  return `${parseFloat((t / Math.pow(g, f)).toFixed(p))} ${C[f]}`;
}, o2 = {
  pdf: {
    fileType: "pdf",
    documentType: "word",
  ...
  var p;
  const d = ((p = Object.values(o2).find((C) => C.mimeType === t)) == null ? void 0 : p.iconType) ?? "";
  if (!t) return /* @__PURE__ */ i.jsx(g2, { width: 20 });
  const g = w2[d];
  return g ? /* @__PURE__ */ i.jsx(g, { width: 20 }) : /* @__PURE__ */ i.jsx(v2, { width: 20 });
}, y2 = "_row_ddbp6_1", E2 = "_highlight_ddbp6_15", b2 = "_rowCheckbox_ddbp6_23", T2 = "_rowCheckboxVisible_ddbp6_31", R2 = "_rowName_ddbp6_49", _2 = "_table_ddbp6_59", K = {
  row: y2,
  highlight: E2,
  rowCheckbox: b2,
...
function j2({
  ...
  const C = !!t.length && t.length === d.length, f = !C && !!d.length, m = (l) => d.includes(l), x = () => p(d.length ? [] : t.map((l) => l.Id)), w = (l) => p(
    ...
    P,
    {
      ...
      children: [
        /* @__PURE__ */ i.jsx(P.Thead, { children: /* @__PURE__ */ i.jsxs(P.Tr, { children: [
          /* @__PURE__ */ i.jsx(P.Th, { c: "gray.6", fw: 500, fz: 10, tt: "uppercase", children: /* @__PURE__ */ i.jsxs(D, { gap: "xs", children: [
            /* @__PURE__ */ i.jsx(
              ee,
              {
                size: "xs",
        ...
        /* @__PURE__ */ i.jsx(P.Tbody, { children: t.map((l) => /* @__PURE__ */ i.jsxs(
          P.Tr,
          {
            className: K.row + (m(l.Id) ? ` ${K.highlight}` : ""),
            onMouseDown: "MimeType" in l ? () => w(l.Id) : void 0,
            children: [
              /* @__PURE__ */ i.jsx(P.Td, { fz: 13, children: /* @__PURE__ */ i.jsxs(D, { gap: "xs", styles: { root: { flexFlow: "noWrap" } }, children: [
                /* @__PURE__ */ i.jsx(k1, { h: 16, w: 16, children: "MimeType" in l && /* @__PURE__ */ i.jsx(
                  ee,
                  {
                    readOnly: !0,
                    size: "xs",
                    checked: m(l.Id),
                    className: K.rowCheckbox
                  }
                ) }),
                /* @__PURE__ */ i.jsxs(D, { gap: 10, styles: { root: { flexGrow: 1, flexWrap: "nowrap" } }, children: [
                  /* @__PURE__ */ i.jsx(
                    x2,
                    {
              ...
              /* @__PURE__ */ i.jsx(P.Td, { fz: 12, c: "dimmed", children: /* @__PURE__ */ i.jsx("span", { title: new Date(l.Timestamp).toLocaleString("ru-Ru"), children: new Date(l.Timestamp).toLocaleString("ru-Ru") }) }),
              /* @__PURE__ */ i.jsx(P.Td, { fz: 12, c: "dimmed", children: "Size" in l ? isNaN(+l.Size) ? null : se(+l.Size) : "-" })
            ]
          },
          l.Id
        )) })
...
function M2({
  ...
  const C = p1(() => {
    ...
    if (m.length > ae) {
      const x = m.splice(1, m.length - ae);
      m.splice(1, 0, { id: 0, title: "...", children: x });
    }
    return m;
  }, [t, d]);
  return /* @__PURE__ */ i.jsxs(D, { h: 48, py: 8, px: "lg", styles: { root: { flexShrink: 0 } }, children: [
    C.length > 1 && /* @__PURE__ */ i.jsx(
      h1,
      {
        variant: "subtle",
        color: "dimmed",
    ...
    /* @__PURE__ */ i.jsx(
      Ne,
      {
        ...
        children: C.map(
          (f, m) => f.children ? /* @__PURE__ */ i.jsxs(d1, { children: [
            /* @__PURE__ */ i.jsx(d1.Target, { children: /* @__PURE__ */ i.jsx(F1, { c: "dimmed", fz: 14, children: "..." }) }),
            /* @__PURE__ */ i.jsx(d1.Dropdown, { children: f.children.map((x) => /* @__PURE__ */ i.jsx(
              d1.Item,
              {
                c: "dark",
                fz: 14,
            ...
            F1,
            {
              ...
              c: m === C.length - 1 ? "dark" : "dimmed",
              fz: 14,
              fw: m === C.length - 1 ? 500 : 400,
              maw: 200,
...
var ce = /* @__PURE__ */ ((t) => (t[t.Docs = 16] = "Docs", t))(ce || {}), I1 = /* @__PURE__ */ ((t) => (t[t.Id = 0] = "Id", t[t.Name = 1] = "Name", t[t.Type = 2] = "Type", t[t.Size = 3] = "Size", t[t.Author = 4] = "Author", t[t.Date = 5] = "Date", t[t.UpdateDate = 6] = "UpdateDate", t))(I1 || {}), O1 = /* @__PURE__ */ ((t) => (t[t.Asc = 0] = "Asc", t[t.Desc = 1] = "Desc", t))(O1 || {});
const m1 = Je.create({
  baseURL: "/api"
}), ie = (t) => m1.get("v1/DocumentDirectory/Get", { params: t }), L2 = (t) => m1.get("v1/DocumentDirectory/Search", {
  params: { ...t, field: "All" }
});
function S2({
  enabledLinks: t,
  ...
  const x = C1("(max-width: 768px)"), w = C1("(max-width: 640px)");
  return /* @__PURE__ */ i.jsxs(i.Fragment, { children: [
    p && /* @__PURE__ */ i.jsx(D, { h: 61, bg: "yellow.4", px: "md", children: /* @__PURE__ */ i.jsx(H1, { fz: 13, c: "dark.7", lh: 1.4, children: `Общий объем отправляемых файлов превышает действующее ограничение
    ...
    /* @__PURE__ */ i.jsxs(
      We,
      {
        ...
        w: "100%",
        children: [
          /* @__PURE__ */ i.jsxs(D, { gap: "xs", children: [
            /* @__PURE__ */ i.jsx(h1, { onClick: C, children: /* @__PURE__ */ i.jsx(P1, { size: 21, color: "#fff" }) }),
            /* @__PURE__ */ i.jsxs(H1, { fz: x ? 13 : 15, children: [
              "Выбрано файлов: ",
              d,
              " (",
              g,
          ...
          /* @__PURE__ */ i.jsxs(D, { gap: "xs", children: [
            /* @__PURE__ */ i.jsx(
              S1,
              {
                ...
                children: d === 1 ? "Прикрепить файл" : "Прикрепить файлы"
              }
            ),
            t && /* @__PURE__ */ i.jsx(
              S1,
...
const k2 = 26214400, H2 = (t) => {
  ...
  return m1.get("v1/Link/Generate", { params: d });
};
...
function V2({
  opened: t,
  enabledLinks: d = !1,
  maxSizeAttachments: g = k2,
  onClose: p,
  onAttachFiles: C,
  offsetSize: f = 0,
  onCreateLink: m
}) {
  const [x, w] = A(le), [l, y] = A(null), [j, k] = A(null), [Z, N] = A(!1), [B, Y] = A([]), [I, T] = A([]), [v1, O] = A(!1), g1 = C1("(max-width: 640px)"), V = p1(() => j ? [...j.Directory.Items, ...j.Document.Items] : [...(l == null ? void 0 : l.Children) ?? [], ...(l == null ? void 0 : l.Documents) ?? []], [l, j]), W = p1(
    () => {
      let c = V.filter((b) => B.includes(b.Id));
      const E = c.map((b) => b.Id), M = I.filter((b) => !E.includes(b.Id));
      return M.length && (c = [...M, ...c]), c;
    },
    [V, B, I]
  ), i1 = p1(
    () => W.reduce((c, E) => c + E.Size, 0),
    [W]
  ), X = f + i1 > g, z = Be(
    async (c) => {
      O(!0);
      try {
        const { data: E } = await ie(c);
        y(E[0]), k(null);
      } finally {
        O(!1);
      }
    ...
    try {
      const J = (await Promise.all(
        c.map(
          ($) => m1.get(`/v1/Documents/Download?id=${$.Id}&download=false`, {
            responseType: "blob"
          })
        )
      )).map(
        ($, Q) => new File([$.data], c[Q].Name, {
          type: $.headers["content-type"] ?? c[Q].MimeType
        })
      );
      Y([]), T([]), C(J), p();
    } catch (b) {
      Ge(b) && console.error(
        ((M = (E = b.response) == null ? void 0 : E.data) == null ? void 0 : M.ErrorMessage) ?? "Неизвестная ошибка"
      );
    } finally {
      O(!1);
    }
  ...
  return ze(() => {
    ...
    Ue,
    {
      ...
      padding: 0,
      onClose: p,
      children: /* @__PURE__ */ i.jsxs(k1, { h: 590, pos: "relative", children: [
        /* @__PURE__ */ i.jsx(Ye, { visible: v1 }),
        /* @__PURE__ */ i.jsx(l2, { onSearch: w1, onClose: p }),
        /* @__PURE__ */ i.jsx(
          M2,
          {
            directory: l,
        ...
        /* @__PURE__ */ i.jsx(
          ...
          {
            style: {
              height: `calc(100% - 48px - 64px - ${B.length ? 76 : 0}px  + ${g1 ? 16 : 0}px - ${X ? 61 : 0}px)`
            },
            children: /* @__PURE__ */ i.jsx(
              j2,
              {
                rows: V,
                selectedRowIds: B,
                onOpenDir: (c) => z({ ...x, id: c }),
                onSelect: (c) => {
                  Y(c);
                  const E = V == null ? void 0 : V.map((b) => b.Id), M = I.filter((b) => !E.includes(b.Id));
                  T(M != null && M.length ? [...M, ...V.filter((b) => c.includes(b.Id))] : V.filter((b) => c.includes(b.Id)));
                }
              }
            )
          }
        ),
        !!B.length && /* @__PURE__ */ i.jsx(
          S2,
          {
            enabledLinks: d,
            count: B.length,
